...
namespace RBEPortalServer.Schema.Updater {
    ...
    //                      14    Current Hour (24)
    //                        56  Current Minute
    [Migration(10000201202281017)]
    public class CreateRequestTables : MigrationTask {

        public override void Up() {
            Database.ExecuteNonQuery(System.Reflection.Assembly.GetExecutingAssembly().GetResourceFileContent("CreateRequestTables.sql"));
        }
